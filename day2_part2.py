with open("input.txt", "r") as a_file:
  ...
  for line in a_file:
    ...
    if  sub_list1[int(list_min_max[0])-1] == str1 and sub_list1[int(list_min_max[1])-1] != str1:
      #print("yes")
      num_of_good_passwords+=1
    elif  sub_list1[int(list_min_max[0])-1] != str1 and sub_list1[int(list_min_max[1])-1] == str1:
      #print("yes")
      num_of_good_passwords+=1
